...
/**
  *@brief  ST7735 RST pin control
	...
	*@retval None
	*/
#define LCD_RST1  HAL_GPIO_WritePin(GPIOC, GPIO_PIN_7,GPIO_PIN_SET);
#define LCD_RST0  HAL_GPIO_WritePin(GPIOC, GPIO_PIN_7,GPIO_PIN_RESET);
...
/**
  *@brief  ST7735 DC pin control
	...
	*@retval None
	*/
#define	LCD_DC1	HAL_GPIO_WritePin(GPIOA, GPIO_PIN_9,GPIO_PIN_SET)
#define	LCD_DC0 HAL_GPIO_WritePin(GPIOA, GPIO_PIN_9,GPIO_PIN_RESET)
...
/**
  *@brief  ST7735 CS pin control
	...
	*@retval None
	*/
#define	LCD_CS1	HAL_GPIO_WritePin(GPIOB, GPIO_PIN_6,GPIO_PIN_SET);
#define	LCD_CS0	HAL_GPIO_WritePin(GPIOB, GPIO_PIN_6,GPIO_PIN_RESET);
